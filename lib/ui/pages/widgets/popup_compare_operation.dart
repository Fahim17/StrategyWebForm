...
class CompareOperationPopUp extends StatefulWidget {
  Function selection;
  CompareOperationPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<CompareOperationPopUp> createState() => _CompareOperationPopUpState();
}

class _CompareOperationPopUpState extends State<CompareOperationPopUp> {
  List allOperation = [
    'Equals',
    'Greater',
    'Greater Equal',
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        widget.selection(allOperation[index]);
                        Navigator.pop(context);
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(10),
                        child: FittedBox(
                            child: Text(allOperation[index],
