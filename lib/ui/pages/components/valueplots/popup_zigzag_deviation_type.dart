...
class ZigZagDeviationTypePopUp extends StatefulWidget {
  Function selection;
  ZigZagDeviationTypePopUp({Key? key, required this.selection})
      : super(key: key);

  @override
  State<ZigZagDeviationTypePopUp> createState() =>
      _ZigZagDeviationTypePopUpState();
}

class _ZigZagDeviationTypePopUpState extends State<ZigZagDeviationTypePopUp> {
  List allValuePlots = [
    'Points',
    'Percent',
  ];
