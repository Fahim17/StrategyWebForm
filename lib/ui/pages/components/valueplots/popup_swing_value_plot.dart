...
class SwingValuePlotPopUp extends StatefulWidget {
  Function selection;
  SwingValuePlotPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<SwingValuePlotPopUp> createState() => _SwingValuePlotPopUpState();
}

class _SwingValuePlotPopUpState extends State<SwingValuePlotPopUp> {
  List allValuePlots = [
    'Swing High',
    'Swing Low',
  ];
