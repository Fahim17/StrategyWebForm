...
class ZigZagValuePlotPopUp extends StatefulWidget {
  Function selection;
  ZigZagValuePlotPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<ZigZagValuePlotPopUp> createState() => _ZigZagValuePlotPopUpState();
}

class _ZigZagValuePlotPopUpState extends State<ZigZagValuePlotPopUp> {
  List allValuePlots = [
    'ZigZag High',
    'ZigZag Low',
  ];
