...
class MACDValuePlotPopUp extends StatefulWidget {
  Function selection;
  MACDValuePlotPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<MACDValuePlotPopUp> createState() => _MACDValuePlotPopUpState();
}

class _MACDValuePlotPopUpState extends State<MACDValuePlotPopUp> {
  List allValuePlots = [
    'Avg',
    'MACD',
    'Diff',
