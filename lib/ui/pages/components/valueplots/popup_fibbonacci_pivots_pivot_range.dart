...
class FibbonacciPivotsPivotRangePopUp extends StatefulWidget {
  Function selection;
  FibbonacciPivotsPivotRangePopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<FibbonacciPivotsPivotRangePopUp> createState() => _FibbonacciPivotsPivotRangePopUpState();
}

class _FibbonacciPivotsPivotRangePopUpState extends State<FibbonacciPivotsPivotRangePopUp> {
  List allValuePlots = [
    'Daily',
    'Weekly',
    'Monthly',
