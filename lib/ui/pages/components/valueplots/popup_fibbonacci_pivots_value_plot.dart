...
class FibbonacciPivotsValuePlotPopUp extends StatefulWidget {
  Function selection;
  FibbonacciPivotsValuePlotPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<FibbonacciPivotsValuePlotPopUp> createState() => _FibbonacciPivotsValuePlotPopUpState();
}

class _FibbonacciPivotsValuePlotPopUpState extends State<FibbonacciPivotsValuePlotPopUp> {
  List allValuePlots = [
    'Pp',
    'R1',
    'R2',
