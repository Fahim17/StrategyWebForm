...
class PriorDayOHLCValuePlotPopUp extends StatefulWidget {
  Function selection;
  PriorDayOHLCValuePlotPopUp({Key? key, required this.selection})
      : super(key: key);

  @override
  State<PriorDayOHLCValuePlotPopUp> createState() =>
      _PriorDayOHLCValuePlotPopUpState();
}

class _PriorDayOHLCValuePlotPopUpState
    extends State<PriorDayOHLCValuePlotPopUp> {
  List allValuePlots = [
    'Prior Open',
    'Prior High',
    'Prior Low',
