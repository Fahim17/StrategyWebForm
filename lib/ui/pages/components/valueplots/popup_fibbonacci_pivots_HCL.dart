...
class FibboPivotsHCLPopUp extends StatefulWidget {
  Function selection;
  FibboPivotsHCLPopUp({Key? key, required this.selection}) : super(key: key);

  @override
  State<FibboPivotsHCLPopUp> createState() => _FibboPivotsHCLPopUpState();
}

class _FibboPivotsHCLPopUpState extends State<FibboPivotsHCLPopUp> {
  List allValuePlots = [
    'Intraday',
    'Daily Bars',
  ];
