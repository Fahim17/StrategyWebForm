...
class StochasticsValuePlotPopUp extends StatefulWidget {
  Function selection;
  StochasticsValuePlotPopUp({Key? key, required this.selection})
      : super(key: key);

  @override
  State<StochasticsValuePlotPopUp> createState() =>
      _StochasticsValuePlotPopUpState();
}

class _StochasticsValuePlotPopUpState extends State<StochasticsValuePlotPopUp> {
  List allValuePlots = [
    'D',
    'K',
  ];
