...
import 'package:ninjastrategy2/datamodel/indicators/sma_datamodel.dart';
import 'package:ninjastrategy2/themes/app_theme_data.dart';

class SMA extends StatefulWidget {
  SMAdatamodel dataModel = SMAdatamodel();
  SMA({Key? key}) : super(key: key);

  @override
  State<SMA> createState() => _SMAState();
}
