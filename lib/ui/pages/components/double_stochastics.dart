...
import 'package:ninjastrategy2/datamodel/indicators/double_stochastics_datamodel.dart';
import 'package:ninjastrategy2/themes/app_theme_data.dart';

class DoubleStochastics extends StatefulWidget {
  DoubleStochasticsdatamodel dataModel = DoubleStochasticsdatamodel();
  DoubleStochastics({Key? key}) : super(key: key);

  @override
  State<DoubleStochastics> createState() => _DoubleStochasticsState();
}

class _DoubleStochasticsState extends State<DoubleStochastics> {
