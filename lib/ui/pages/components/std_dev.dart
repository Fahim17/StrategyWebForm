...
import 'package:ninjastrategy2/datamodel/indicators/std_dev_datamodel.dart';
import 'package:ninjastrategy2/themes/app_theme_data.dart';

class StandardDeviation extends StatefulWidget {
  StandardDeviationdatamodel dataModel = StandardDeviationdatamodel();
  StandardDeviation({Key? key}) : super(key: key);

  @override
  State<StandardDeviation> createState() => _StandardDeviationState();
}

class _StandardDeviationState extends State<StandardDeviation> {
